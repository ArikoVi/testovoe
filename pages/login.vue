        ...
        <div class="form-group wrap-login100" >
            <!-- <form class="login100-form validate-form"> -->
                ...
                <div class="wrap-input100 validate-input" data-validate="Enter password">
                    <input class="input100 password" id="password-input" type="password" name="pass">
                ...
                <div class="container-login100-form-btn">
                    <div class="wrap-login100-form-btn">
                        ...
                        <button class="login100-form-btn stylistics_knopkam maiden " type="submit" >	
                            <!-- <p >
...
.stylistics_knopkam:focus {
 ...
 .stylistics_knopkam.maiden {
  background-image: linear-gradient(to right, #5a70d4, #834fb9, #5a80d2, #892ad8);
